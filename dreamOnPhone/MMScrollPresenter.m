...
static int const MMTitleViewHeight = 130;
...
- (void)addIconToPage:(MMScrollPage *)page
{
...
- (void)addTitleViewForPage:(MMScrollPage *)page atIndex:(int)index
{
...
- (void)addSubviewsToPage:(MMScrollPage *)page
{
...
- (void)setupFramesForPage:(MMScrollPage *)page atIndex:(int)pageArrayIndex
{
    UIImageView *iconView = [[UIImageView alloc] initWithImage:page.icon];
